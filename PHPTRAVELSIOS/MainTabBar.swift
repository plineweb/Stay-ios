    ...
    override func viewDidLoad() {
        ...
        for i in 0..<m_arr.count {
            ...
            if m.type == "1"
            {
                ...
                self.addChildViewController(HotelController)
            ...
            }else  if m.type == "0"
            {
                ...
                self.addChildViewController(TourController)
                ...
                self.addChildViewController(CarController)
            }else if m.type == "5"{
                ...
                let CarController = UINavigationController.init(rootViewController: pt_car_tabs)
                CarController.tabBarItem=UITabBarItem.init(title: "IVISA", image: #imageLiteral(resourceName: "passport"), tag: 0)
                self.addChildViewController(CarController)
            }
        ...
        let attributes: [String: AnyObject] = [NSFontAttributeName:UIFont(name: "Open Sans", size: 14)!, NSForegroundColorAttributeName: UIColor.white]
